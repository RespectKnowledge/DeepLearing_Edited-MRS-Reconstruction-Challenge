# -*- coding: utf-8 -*-
"""
Created on Tue Mar 28 01:13:31 2023
...
model = UNET(40).float()
model.load_state_dict(torch.load("torch_weights_task3_base_combinee_4096_finallast1.pth"))
model.eval()
#%%
...
with h5py.File("D:/reconsrtcionMRI/task3/task3/track_03_test_data.h5") as hf:
    ppm=hf['data_4096']["ppm"][()]
    t=hf['data_4096']["t"][()]
    #y=hf['data_2048']["target_spectra"][()]
    noise_fid=hf['data_4096']["transient_fids"][()]#12*2048*2*160 ##input signal
...
for i,d in enumerate(train_dataloader):
    ...
    #del pred
    #break
pred_task3_4096=np.array(predf)
#%%  save predictions ###########################
import h5py
import numpy as np
...
save_submission(pred_task3_4096,ppm_test.numpy(),"track03_invivo_hetrogen_4096.H5")